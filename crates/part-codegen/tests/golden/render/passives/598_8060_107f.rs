/// 598-8060-107F — 0603 SMT LED,YELLOWGREEN,ALINGAP,WATER CLEAR LENS,140 DEG VIEWING ANGLE | Dialight 598-8060-107F
///
/// # Pinout
///
...
impl copperleaf::Component for Comp5988060107f {
    ...
    fn meta(&self) -> &copperleaf::ComponentMeta {
        ...
        META.get_or_init(|| copperleaf::ComponentMeta {
            symbol: Some("598-8060-107F".into()),
            
            footprint: Some("598-8060-107F".into()),
...
impl Default for Comp5988060107f {
    fn default() -> Self {
        Self::new()
    }
}
