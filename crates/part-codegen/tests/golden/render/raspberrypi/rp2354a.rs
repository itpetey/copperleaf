...
/// |-----|----------|-------------|-----------------------|
/// | 1   | IOVDD_1  | Supply      | I/O supply            |
/// | 2   | GPIO0    | GPIO        |                       |
/// | 3   | GPIO1    | GPIO        |                       |
/// | 4   | GPIO2    | GPIO        |                       |
/// | 5   | GPIO3    | GPIO        |                       |
/// | 6   | DVDD_1   | Supply      | Core supply           |
/// | 7   | GPIO4    | GPIO        |                       |
/// | 8   | GPIO5    | GPIO        |                       |
/// | 9   | GPIO6    | GPIO        |                       |
/// | 10  | GPIO7    | GPIO        |                       |
/// | 11  | IOVDD_2  | Supply      | I/O supply            |
/// | 12  | GPIO8    | GPIO        |                       |
/// | 13  | GPIO9    | GPIO        |                       |
/// | 14  | GPIO10   | GPIO        |                       |
/// | 15  | GPIO11   | GPIO        |                       |
...
/// | 36  | GPIO24   | GPIO        |                       |
/// | 37  | GPIO25   | GPIO        |                       |
/// | 38  | IOVDD_5  | Supply      | I/O supply            |
/// | 39  | DVDD_3   | Supply      | Core supply           |
...
/// | 45  | IOVDD_6  | Supply      | I/O supply            |
/// | 46  | VREG_AVDD | Supply      | Voltage regulator supply |
/// | 47  | VREG_PGND | Ground      |                       |
/// | 48  | VREG_LX  | I/O         | Voltage regulator switch node |
/// | 49  | VREG_VIN | Supply      | Voltage regulator input |
/// | 50  | VREG_FB  | I/O         | Voltage regulator feedback |
/// | 51  | USB_DM   | USB         |                       |
/// | 52  | USB_DP   | USB         |                       |
...
impl Rp2354a {
    pub const IOVDD_1: copperleaf::PinRef = copperleaf::PinRef("IOVDD_1");
    ...
    pub const DVDD_1: copperleaf::PinRef = copperleaf::PinRef("DVDD_1");
    ...
    pub const IOVDD_2: copperleaf::PinRef = copperleaf::PinRef("IOVDD_2");
    ...
    pub const IOVDD_3: copperleaf::PinRef = copperleaf::PinRef("IOVDD_3");
    pub const XIN: copperleaf::PinRef = copperleaf::PinRef("XIN");
    pub const XOUT: copperleaf::PinRef = copperleaf::PinRef("XOUT");
    pub const DVDD_2: copperleaf::PinRef = copperleaf::PinRef("DVDD_2");
    ...
    pub const IOVDD_4: copperleaf::PinRef = copperleaf::PinRef("IOVDD_4");
    ...
    pub const IOVDD_5: copperleaf::PinRef = copperleaf::PinRef("IOVDD_5");
    pub const DVDD_3: copperleaf::PinRef = copperleaf::PinRef("DVDD_3");
    ...
    pub const IOVDD_6: copperleaf::PinRef = copperleaf::PinRef("IOVDD_6");
    ...
    pub fn new() -> Self {
        ...
        Self {
            pins: vec![
                Pin::build("IOVDD_1").number("1").pos(-3.45, -2.8).rotation(0.0).length(0.8).width(0.8).height(0.2).pad_type("smd").pad_shape("roundrect").roundrect_rratio(0.25).layers("F.Cu F.Mask F.Paste").pwr(1.8.volt(), 3.3.volt(), 0.1.amp()).pin(),
                ...
                Pin::build("DVDD_1").number("6").pos(-3.45, -0.8).rotation(0.0).length(0.8).width(0.8).height(0.2).pad_type("smd").pad_shape("roundrect").roundrect_rratio(0.25).layers("F.Cu F.Mask F.Paste").pwr(1.1.volt(), 1.1.volt(), 0.1.amp()).pin(),
                ...
                Pin::build("IOVDD_2").number("11").pos(-3.45, 1.2).rotation(0.0).length(0.8).width(0.8).height(0.2).pad_type("smd").pad_shape("roundrect").roundrect_rratio(0.25).layers("F.Cu F.Mask F.Paste").pwr(1.8.volt(), 3.3.volt(), 0.1.amp()).pin(),
                ...
                Pin::build("IOVDD_3").number("20").pos(-1.2, 3.45).rotation(0.0).length(0.8).width(0.2).height(0.8).pad_type("smd").pad_shape("roundrect").roundrect_rratio(0.25).layers("F.Cu F.Mask F.Paste").pwr(1.8.volt(), 3.3.volt(), 0.1.amp()).pin(),
                ...
                Pin::build("DVDD_2").number("23").pos(0.0, 3.45).rotation(0.0).length(0.8).width(0.2).height(0.8).pad_type("smd").pad_shape("roundrect").roundrect_rratio(0.25).layers("F.Cu F.Mask F.Paste").pwr(1.1.volt(), 1.1.volt(), 0.1.amp()).pin(),
                ...
                Pin::build("IOVDD_4").number("30").pos(2.8, 3.45).rotation(0.0).length(0.8).width(0.2).height(0.8).pad_type("smd").pad_shape("roundrect").roundrect_rratio(0.25).layers("F.Cu F.Mask F.Paste").pwr(1.8.volt(), 3.3.volt(), 0.1.amp()).pin(),
                ...
                Pin::build("IOVDD_5").number("38").pos(3.45, 0.0).rotation(0.0).length(0.8).width(0.8).height(0.2).pad_type("smd").pad_shape("roundrect").roundrect_rratio(0.25).layers("F.Cu F.Mask F.Paste").pwr(1.8.volt(), 3.3.volt(), 0.1.amp()).pin(),
                Pin::build("DVDD_3").number("39").pos(3.45, -0.4).rotation(0.0).length(0.8).width(0.8).height(0.2).pad_type("smd").pad_shape("roundrect").roundrect_rratio(0.25).layers("F.Cu F.Mask F.Paste").pwr(1.1.volt(), 1.1.volt(), 0.1.amp()).pin(),
                ...
                Pin::build("IOVDD_6").number("45").pos(3.45, -2.8).rotation(0.0).length(0.8).width(0.8).height(0.2).pad_type("smd").pad_shape("roundrect").roundrect_rratio(0.25).layers("F.Cu F.Mask F.Paste").pwr(1.8.volt(), 3.3.volt(), 0.1.amp()).pin(),
                ...
                Pin::build("VREG_LX").number("48").pos(2.0, -3.45).rotation(0.0).length(0.8).width(0.2).height(0.8).pad_type("smd").pad_shape("roundrect").roundrect_rratio(0.25).layers("F.Cu F.Mask F.Paste").dio(),
                ...
                Pin::build("VREG_FB").number("50").pos(1.2, -3.45).rotation(0.0).length(0.8).width(0.2).height(0.8).pad_type("smd").pad_shape("roundrect").roundrect_rratio(0.25).layers("F.Cu F.Mask F.Paste").dio(),
