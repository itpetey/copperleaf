...
Allow the Copperleaf CLI to load external design JSON files and provide reusable reporting and baseline emission subcommands, making the CLI usable for real projects instead of only the built-in example design.
